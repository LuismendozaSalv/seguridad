...
$this->title = 'Copias de Seguridad y Respaldo';
...
<div class="row">
    <div class="col-md-12">
        ...
        kartik\grid\GridView::widget([
            ...
            'hover' => true,
            'panel' => [
                'heading' => '<h3 class="panel-title"> Backup de Archivos de Base de Datos</h3>',
                'type' => 'primary',
                'showFooter' => false
            ],
            // set your toolbar
            'toolbar' => [
                ['content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>  Generar Backup ', ['create'], ['class' => 'btn btn-success create-backup margin-right5'])
                ],
            ],
            'columns' => array(
                'name',
